    ...
    private JobSettings.JobScheduleSettings getScheduleSettings(JobSchedule jobSchedule) {
        ...
        switch (jobSchedule.getType()) {
            ...
            case DAILY_TIME:
                ...
                scheduleSettings.setStartTimeOfDay(dailyTimeIntervalJobSchedule.getStartTimeOfDay());
                scheduleSettings.setEndTimeOfDay(dailyTimeIntervalJobSchedule.getEndTimeOfDay());
                scheduleSettings.setDaysOfWeek(dailyTimeIntervalJobSchedule.getDaysOfWeek());
                break;
            case CALENDAR:
                ...
                scheduleSettings.setTimeZone(calendarIntervalJobSchedule.getTimeZone());
                break;
            default:
